...
export function Hero() {
  ...
  return (
    <>
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-cream-500 halftone-bg-light">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl sm:text-2xl text-gray-900 mb-10 leading-relaxed max-w-3xl mx-auto font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-20">
            {[
              ...
              >
                <div className={`${agent.color} rounded-xl p-8 border-4 border-black comic-shadow hover:comic-shadow-lg transition-all duration-300 hover:-translate-y-2 hover:scale-105 halftone-bg-light`}>
                  ...
                  <div className="bg-black text-white px-5 py-4 -mx-6 -mb-6 border-t-4 border-black rounded-b-lg">
