...
export default function SwitchboardOperatorPage() {
  const role = aiRoles.find((r) => r.slug === 'switchboard-operator')!;
  const otherRoles = getOtherRoles('switchboard-operator');
