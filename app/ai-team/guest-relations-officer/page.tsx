...
export default function GuestRelationsOfficerPage() {
  const role = aiRoles.find((r) => r.slug === 'guest-relations-officer')!;
  const otherRoles = getOtherRoles('guest-relations-officer');
